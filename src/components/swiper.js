...
export default class Swiper extends Component{
    ...
    */
    static propTypes = {
        ...
        pageNavigationStyle: PropTypes.object,
    ...
    constructor(props) {
        ...
        this.ezswiper = {
            ...
            offset:offset,
            pageNavigationStyle:props.pageNavigationStyle
        }
    ...
    */
    ...
    pageNavigation(){
        ...
        const count = this.ezswiper.dataSource.length;
        const views = [];

        for (let i = 0; i < count; i++) {
            views.push(
                <View key={i} style={styles.pageNavigation}>
                    <TouchableHighlight
                        underlayColor='transparent'
                        onPress={()=>{}}
                        style={styles.pageNavigationItem}
                    >
                        <Text>2</Text>
                    </TouchableHighlight>
                </View>
    ...
    render() {
        const { width, height } = this.props;
        return (
            <View style={[this.props.style, { overflow: 'hidden',position:"relative"}]}>
                <ScrollView
                    style={{ backgroundColor: 'transparent', opacity: this.state.initialized ? 1 : 0,position:"relative" }}
